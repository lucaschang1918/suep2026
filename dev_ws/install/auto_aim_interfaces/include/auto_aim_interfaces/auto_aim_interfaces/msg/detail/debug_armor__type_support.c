...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__DebugArmor__rosidl_typesupport_introspection_c__DebugArmor_message_member_array[4] = {
  {
    "center_x",  // name
